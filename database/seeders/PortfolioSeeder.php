    ...
    public function run()
    {
        try {
            ...
            try {
                ...
                $data = [
                    'name' => 'Muhammad Ammar Altaf',
                    'email' => 'mammaraltaf@gmail.com',
                    'avatar' => 'assets/common/img/avatar/default1.png',
                ...
                try {
                    $data = [
                        ...
                        'thesis' => 'Generating and Evaluating the Utility of Synthetic Covid-19 Tabular Data Using Generative Adversarial Networks (GANs)'
                    ];
                    $education->store($data);

                    $data = [
                        'institution' => 'Federal Urdu University of Arts, Science and Technology, Islamabad, Pakistan',
                        'period' => '2014-2018',
                    ...
                    $data = [
                        'institution' => 'Islamabad College for Boys G-6/3, Islamabad, Pakistan',
                        'period' => '2012-2014',
                        'degree' => 'HSSC',
                        'cgpa' => null,
                        'department' => null,
                    ...
                    $data = [
                        'institution' => 'PAEC Model College Nilore, Islamabad, Pakistan',
                        'period' => '2010-2012',
                        'degree' => 'SSC',
                        'cgpa' => null,
                        'department' => null,
